...
namespace DBHandler
{
    ...
    {
        //static string ConnString = "Server=192.168.0.63;Database=tsp;Uid=master;Pwd=master123!#$;SSL Mode=None";
        static string ConnString = "Server=10.39.167.211;Database=tsp;Uid=master;Pwd=master123!#$;SSL Mode=None";
